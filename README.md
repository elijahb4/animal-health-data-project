...
## How to run locally
### Prerequisites
- Local development computer with web server installed
- Local development computer with PHP installed - additional installation instructions are provided later
...
#### PHP
If you installed PHP as part of a bundle such as XAMPP, skip this step.
...
4. Open your web browser and type 'localhost' as the URL or 'localhost:<port_number>' if your server requires it (PHP's does)
---
